...
> [!tip] TIP
> You can automatically format your code indentations in the Arduino IDE with the keyboard shortcut `Ctrl-T` on Windows/Linux or `CMD + T` on Mac, or go to Edit > Auto Format.
